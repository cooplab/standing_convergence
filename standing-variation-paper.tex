...
complicated by the hemizygosity of males][]{XXX}. 
...
we estimate that $s_d$ has to be roughly \gc{XXX to XXX}, 
...
\citet{softsweepsI,Orr:01}. However, having more established standing alleles
...
differs markedly from the case of multiple competing alleles in a panmictic population \citep{softsweepsI,softsweepsII}. 
...
\gc{In cases, such as malaria resistance and skin pigmentation, where we
know something about the genetics, phenotypic distributions, 
and potential selection agents we can usually avoid mistaking the }
...
at intermediate frequency will be somewhat different \citep{Barton:89},
...
if they are selective excluded, may allow Dobzhansky-Muller incompatibilities (DMIs) to arise
...
the range \citep{Bank:12,Kondrashov:03,bierne2011coupling}. Indeed the alleles that act as components in many

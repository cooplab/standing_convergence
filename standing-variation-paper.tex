...
whether adaptation is mutation-limited \citep{karasov2010}, and whether
species should be regarded to cohesive units. Convergence within
populations also effects our
ability to detect adaptation from population genomic data as no one
...
convergent evolution as alleles are unable to spread through intervening populations \citep{RalphCoop:14}.
...
Here we extend our spatial model from \citep{RalphCoop} to include standing

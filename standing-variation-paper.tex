...
$\rho$ of haploid individuals \gc{(twice the number of diploid individuals)} per unit area.
...
have simply not had time for neutral mixing to spread them across the
landscape. \gc{Such convergent alleles will be $F_{ST}$-outliers compared to
  ...
  migration to smooth out them out.}

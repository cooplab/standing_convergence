...
% interpolates   panmixia and 2010
...
it. In one dimension things are a little prettier and the characteristic length is $\chi = ( \sqrt{\lambda_0^2 + 2 \lambda/v} - \lambda_0 )/( 2 \lambda / v )$.
...
shape of area $G$ and diameter $\sqrt{G}$. Denote the total effective population size
...
\sqrt{G}$. Measuring distance in units of the diameter of $\sqrt{G}$,
...
\end{align}
For applications we evaluate this integral numerically.   %For means of evaluating this integral, see Appendix \ref{apx:integrals}.
...
%\plr{put in this value in terms of Gaussian CDF?}
...
mutations (stars). (Note that the standing variants arose at times
prior to $t=0$.)
...
One of the ways we derive various results in the text is by taking a
...
$\mu = 10^{-6}$ and $s_b = 0.05$. As the characteristic length with
...
holding the prior disadvantage of the allele fixed at $s_d=0.05$ and the mutation rate fixed at $\mu=10^{-6}$.  
...
\caption{ %
{\bf Mean adaptation times} as a function of selective advantage and disadvantage.
...
as a function of selective disadvantage, at two population densities.
